...
// DemoMock 返回一个为「多方向提案(propose)」与全部流水线阶段预注册了丰富、可信示例
// 的 *Mock，这样在没有 API Key 的情况下，服务/CLI 既能演示「先选立意再生成全案」，
// 也能产出一份完整、合理的方案。题材是面向中国国内市场、
...
func DemoMock() *Mock {
	...
	// assist: 提示词助手——把用户的粗略想法扩写成一段完整生成需求。Mock 忽略输入，
	// 固定返回一个高质量示例需求，便于无 Key 演示「AI 扩写」按钮。
	m.Register("assist", `{"requirement":"做一部面向中国国内市场的竖屏短剧《家装改造逆袭》：被丈夫和小三联手赶出家门、净身出户的女设计师，蜗居进一间破旧出租屋，却凭一双巧手把它一步步爆改成全网爆款样板间。核心爽点是逆袭打脸与阶层跃升——每集靠一处惊艳改造打脸曾看轻她的人，并在结尾揭晓她豪门继承人的隐藏身份。基调高级、情绪浓烈、节奏紧凑，适配抖音/快手/红果短剧。Ashley 家具自然植入关键情绪节点：和解时的客厅沙发、重新开始时的卧室套装、团圆饭的餐桌，让每一次改造高光都顺势成为带货入口。"}`)

	// propose: 3 个「显著不同」的立意方向，用于无 Key 演示「先选立意再生成全案」。
	m.Register("propose", `{"concepts": [
		{
			...
			"tropesUsed": ["离婚后爆改出租屋", "家装改造逆袭", "扮猪吃虎"]
		},
		{
			"logline": "毒舌家具匠人与冷面女总裁被迫合租一套样板间，从针锋相对到联手打造梦想之家，每一件亲手布置的家具都成了两人关系升温的见证。",
			"theme": "在共建一个家的过程中，学会让另一个人住进自己的人生",
			"audience": "偏爱欢喜冤家、双向奔赴甜宠 + 治愈系家装内容的年轻女性观众",
			"tone": "轻松甜宠、笑点密集、暖意收尾",
			"payoffEngine": "双向奔赴式心动暴击：每一集两人在布置一处家居空间时擦出火花，以一个甜到尖叫的反转互动收束。",
			"coreConflict": "一个要把家做成作品，一个要把家做成生意，两种南辕北辙的人生观必须在同一个屋檐下达成和解。",
			"tropesUsed": ["欢喜冤家合租", "双向奔赴", "家装改造逆袭"]
		},
		{
			"logline": "新婚之夜搬进的婚房处处透着诡异，女主循着家具摆设里的隐秘线索，一步步揭开前任女主人离奇失踪的真相，也揭开丈夫精心布置的惊天骗局。",
			"theme": "家应当是港湾，而非牢笼——以及看清真相后重新夺回人生的勇气",
			"audience": "爱看悬疑反转 + 都市惊悚、追求高密度信息钩子的男女通吃观众",
			"tone": "悬疑冷冽、步步惊心、反转不断",
			"payoffEngine": "悬疑解谜式反转打脸：每一集靠一处家居细节揭穿一个谎言，真相层层反转直至女主绝地翻盘。",
			"coreConflict": "她必须在看似完美的婚房里分辨爱意与杀机，在被操控之前先识破并反杀这场布局。",
			"tropesUsed": ["婚房惊魂", "悬疑反转", "绝地反杀"]
		}
	]}`)
